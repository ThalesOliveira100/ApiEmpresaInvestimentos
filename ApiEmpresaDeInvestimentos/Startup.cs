...
namespace ApiEmpresaDeInvestimentos
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<AppDbContext>(opts => opts.UseLazyLoadingProxies().UseMySQL(Configuration.GetConnectionString("ContaConnection")));
            ...
            services.AddScoped<SaqueService, SaqueService>();
