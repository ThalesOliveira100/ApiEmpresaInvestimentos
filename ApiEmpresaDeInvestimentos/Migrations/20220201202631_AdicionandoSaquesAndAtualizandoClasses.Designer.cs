...
namespace ApiEmpresaDeInvestimentos.Migrations
{
    ...
    [Migration("20220201202631_AdicionandoSaquesAndAtualizandoClasses")]
    partial class AdicionandoSaquesAndAtualizandoClasses
    {
            ...
            modelBuilder.Entity("ApiEmpresaDeInvestimentos.Models.Depositos", b =>
                {
                    ...
                    b.Property<string>("OrigemCpf")
                        .HasColumnType("text");

                    b.Property<string>("OrigemInstituicao")
                        .HasColumnType("text");
